...
check() {
  ...
  # Tests failed as of 14.0, but upstream suggests that the failing tests can be disregarded: https://bitbucket.org/pypa/setuptools/issue/360/test-suite-fails-for-the-140-release
